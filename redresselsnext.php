...
<!--<img src="4th_Convocation.jpg" width="500px;" height="438px;"></img>-->
						...
						<div class="post-meta clearfix">
							...
							<div class="post-title">
								<h2><font size="" color="#FF0066">Staff Grievance Registration Form - OTP Approval</font></h2>
...
$regno=$_POST['regno'];
  ...
  //echo "http://bulk.kitesms.com/spanelv2/api.php?username=laravignan&password=Laratech$459&to=".$phoneno."&from=VLITSS&message=".$msg."";

		  

$query="insert into grievanceoregister values('0','".$name."','".$phoneno."','".$regno."','".$otp."','',0,'','','1970-01-01','','1970-01-01')";
//echo $query;
...
?>
	<form action="grievances.php" method="post">
					...
					<!-- //switch -->
					<input type="hidden" name="mobile" value='<?php echo $phoneno;?>'>
