...
$roll = "20FE1A0568";
$name = "praveen";
$msg = "hello testing this message and only for the testing purpose";
$time = "somewhat";
          			...
          			<td style="padding-bottom: 30px;">
		                ...
		                <td valign="middle" width="50%">
		                  <div class="text-blog" style="text-align: left; padding-left:25px;">
		                  	<p class="meta"><span>This was a <?php echo $type;?> grievance </p>
				              	<h2>DETAILS OF THE GRIEVANCE REPORT</h2>
								<?php
								if($type == "student"){
									echo "<p><span style = color:green>Student register number: </span> ".$roll;
								} else if($type == "parent"){
									echo "<p><span style = color:red>Parent name : </p><span style = color:green>".$name;echo "<br>";
									echo "<p><span style = color:red>Ward register number : </p>".$roll;echo "<br>";
								} else if($type == "staff"){
									echo "<p>Staff name:</p>".$name;echo "<br>";
									echo "<p>Staff register number : </p>".$roll;echo "<br>";
								}
								echo "<h3><span style = color:red>The Grievance report is : \n </h3>".$msg;
								echo "<p>Date and time : \n".$time;echo "<br>";
								?>
				         
				              	<p><a href=<?php echo $link1;?> class="btn btn-primary">Issue assigned</a></p><br>
								<p><a href=<?php echo $link2;?> class="btn btn-primary">Issue solved</a></p><br>
		                  </div>
		                </td>
          				</table>
          			</td>
        ...
        <tr>
        	<td class="bg_white">
        		<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        			<tr>
                <td>
                  <a href="#"><img src="images/bg_2.jpg" alt="" style="width: 100%; max-width: 600px; height: auto; margin: auto; display: block;"></a>
                </td>
              </tr>
              <tr>
