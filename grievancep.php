			...
			<div class="row">
				<div class="col-lg-3 wow slideInLeft">
					...
					<div class="service-tab-title">
						<ul class="clearfix">
						<li class="active" data-tab-name="parent">Parent Grievance Registration</li>
...
<form action="" method="post">
					<div class="form-style-agile form-group" name="contact" onSubmit="return chklogfrm(contact.otp.value)" style="margin-top: -30px;">
						<label>
							Enter Correct OTP
