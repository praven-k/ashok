...
<div class="content-block">
         <div class="section-full bg-white content-inner">
            <div class="container-fluid" style="padding:10px 30px 10px 80px">
                  ...
                  <div class="row">
                      <?php include ('civsidebar.php');?>
        <div class="col-lg-9 col-md-12 col-sm-12" > 
        <h3 style="font-size: 23px;background-color: #1C378A;color: white;font-weight:500;padding-left: 5px">Faculty List</h3>      
                            <br>  
...
<tbody>
<tr>
<th  style="font-family:verdana;font-size:12px;"   width="56">
 S.NO 
</td>
<th  style="font-family:verdana;font-size:12px;"   width="236">
 NAME OF THE FACULTY 
</td>
<th  style="font-family:verdana;font-size:12px;"   width="180">
 DESIGNANTION 

</tr>
<tr>
<td  style="font-family:verdana;font-size:12px;"   width="56">
 1 
</td>
<td  style="font-family:verdana;font-size:12px;"   width="236">
 Dr. M. Jemimah Carmichael 
</td>
<td  style="font-family:verdana;font-size:12px;"   width="180">
 Professor & HOD 
</td>
...
<td  style="font-family:verdana;font-size:12px;"   width="236">
 Mr.Vendidandala Venkata Ramesh Reddy 
</td>
<td  style="font-family:verdana;font-size:12px;"   width="180">
 Asst. Prof 
</td>
